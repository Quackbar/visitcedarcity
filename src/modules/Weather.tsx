...
const Weather: React.FC<WeatherProps> = ({ CedarImg, CedarTemp, ParoImg, ParoTemp, BrianImg, BrianTemp }) => {
  if (CedarImg === "" || ParoImg === "" || BrianImg === "") {
    return (
      <IonCardHeader class="centered">
        <h3>
          Unfortunately the fetch for weather data took longer than 10 seconds. We are now putting this app in offline
