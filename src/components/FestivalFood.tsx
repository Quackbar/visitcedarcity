...
const openBunisas = async () => {
    await Browser.open({ url: "https://www.google.com/maps/place/Bunnisa's+Thai+Cuisine/@37.6775062,-113.0645432,17z/data=!3m2!4b1!5s0x80b561b834307693:0x4b8e9b30b29c768!4m5!3m4!1s0x80b56107561cf149:0x88f968c1a7b5d2a0!8m2!3d37.677502!4d-113.0623545"});
  };

const openGrind = async () => {
    await Browser.open({ url: "https://www.google.com/maps/place/Grind+Coffee+House/@37.6778182,-113.0642637,17z/data=!3m1!4b1!4m5!3m4!1s0x80b561ba6c5fbe1d:0x3fefb7b70324df72!8m2!3d37.677814!4d-113.062075"});
  };

const openCentro = async () => {
    await Browser.open({ url: "https://www.google.com/maps/place/Centro+Woodfired+Pizzeria/@37.6827687,-113.1001246,14z/data=!4m9!1m2!2m1!1scentro!3m5!1s0x80b561ba4714611d:0x7aec392aed6bea71!8m2!3d37.6775706!4d-113.0626666!15sCgZjZW50cm9aCCIGY2VudHJvkgEQcGl6emFfcmVzdGF1cmFudA"});
  };
const openBristle = async () => {
    await Browser.open({ url: "https://www.google.com/maps/place/Bristlecone/@37.6770152,-113.0628837,20.94z/data=!4m5!3m4!1s0x80b561ec3edf9a19:0x455c0ad0d69f4328!8m2!3d37.6770122!4d-113.062948"});
  };
const openPastry = async () => {
    await Browser.open({ url: "https://www.google.com/maps/place/Pastry+Pub,+Inc./@37.6773614,-113.0630487,20.11z/data=!4m5!3m4!1s0x0:0x16701213e53c0ea6!8m2!3d37.6775703!4d-113.0631248"});
  };
