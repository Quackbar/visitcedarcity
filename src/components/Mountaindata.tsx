...
const MountainData: React.FC<MountainProps> = ({ BaseDepth,
    OneDaySnowfall,
    LiftsOpen,
    TrailsOpen,
    }) => {
    ...
    if(BaseDepth === "" || TrailsOpen === ""){
        ...
        <IonCardHeader class="centered" >
            <h3>Unfortunately the fetch for mountain data took longer than 10 seconds. We are now putting this app in offline mode. Sorry for the inconvenience. </h3>
        </IonCardHeader>
        );
    }
    else{
